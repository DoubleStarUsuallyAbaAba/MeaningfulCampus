...
file_path = '/root/autodl-tmp/palm/dataset/test1.txt'
#weight_path = '/root/autodl-tmp/palm/my_pth/MobileViT/MobileViT_20230608_224728/best.pth'
weight_path = '/root/autodl-tmp/palm/my_pth/MobileFaceNet/MobileFaceNet_v2_20230608_152244/best.pth'
...
test_loader = torch.utils.data.DataLoader(test_imgs, batch_size = 64, pin_memory = True, shuffle=False, num_workers=24)
